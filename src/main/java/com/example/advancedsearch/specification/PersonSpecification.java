...
public class PersonSpecification {
    ...
    public Specification<Person> people(PersonFilter filter) {
        return (root, query, criteriaBuilder) -> {
            ...
            if(!ObjectUtils.isEmpty(filter.getEmail())) {
                predicateList.add(
                        criteriaBuilder.like(
                                ...
                                filter.getEmail().toLowerCase().concat("%")
                        )
                );
            }
            ...
            if(!ObjectUtils.isEmpty(filter.getDistrict())) {
                predicateList.add(
                        criteriaBuilder.like(
                                criteriaBuilder.upper(root.get("district")),
                                filter.getDistrict().toUpperCase().concat("%")
                        )
                );
            }
            ...
            if(!ObjectUtils.isEmpty(filter.getCity())) {
                predicateList.add(
                        criteriaBuilder.like(
                                ...
                                filter.getCity().toUpperCase().concat("%")
                        )
                );
            }
            ...
            if(!ObjectUtils.isEmpty(filter.getState())) {
                predicateList.add(
                        criteriaBuilder.like(
                                ...
                                filter.getState().toUpperCase().concat("%")
                        )
                );
            }
